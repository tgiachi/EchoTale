...
public static class EchoTaleDslParser
{
    ...
    private static readonly Parser<string> StringLiteral =
        ...
        from content in Sprache.Parse
                               .Char('\\')
                               .Then(_ => Sprache.Parse.Chars('\\', '"', 'n', 'r', 't').Select(ConvertEscape))
    ...
    private static readonly Parser<(RoomDeclaration? Room, ObjectDeclaration? Object, RuleDeclaration? Rule,
        PlayerDeclaration? Player, string? Include, string? Author, string? Version, IReadOnlyList<VoiceDeclaration>? Voices,
        IReadOnlyList<SoundDeclaration>? Sounds, IReadOnlyList<MusicDeclaration>? Music)> Declaration =
        (from room in Sprache.Parse.Ref(() => Room)
         select (room, (ObjectDeclaration?)null, (RuleDeclaration?)null, (PlayerDeclaration?)null, (string?)null,
                 (string?)null, (string?)null, (IReadOnlyList<VoiceDeclaration>?)null,
                 (IReadOnlyList<SoundDeclaration>?)null, (IReadOnlyList<MusicDeclaration>?)null))
        .Or(
            from obj in Sprache.Parse.Ref(() => GameObject)
            select ((RoomDeclaration?)null, obj, (RuleDeclaration?)null, (PlayerDeclaration?)null, (string?)null,
                    (string?)null, (string?)null, (IReadOnlyList<VoiceDeclaration>?)null,
                    (IReadOnlyList<SoundDeclaration>?)null, (IReadOnlyList<MusicDeclaration>?)null)
        )
        .Or(
            from rule in Sprache.Parse.Ref(() => Rule)
            select ((RoomDeclaration?)null, (ObjectDeclaration?)null, rule, (PlayerDeclaration?)null, (string?)null,
                    (string?)null, (string?)null, (IReadOnlyList<VoiceDeclaration>?)null,
                    (IReadOnlyList<SoundDeclaration>?)null, (IReadOnlyList<MusicDeclaration>?)null)
        )
        .Or(
            from player in Sprache.Parse.Ref(() => Player)
            select ((RoomDeclaration?)null, (ObjectDeclaration?)null, (RuleDeclaration?)null, player, (string?)null,
                    (string?)null, (string?)null, (IReadOnlyList<VoiceDeclaration>?)null,
                    (IReadOnlyList<SoundDeclaration>?)null, (IReadOnlyList<MusicDeclaration>?)null)
        )
        .Or(
            from include in Sprache.Parse.Ref(() => Include)
            select ((RoomDeclaration?)null, (ObjectDeclaration?)null, (RuleDeclaration?)null, (PlayerDeclaration?)null,
                    include, (string?)null, (string?)null, (IReadOnlyList<VoiceDeclaration>?)null,
                    (IReadOnlyList<SoundDeclaration>?)null, (IReadOnlyList<MusicDeclaration>?)null)
        )
        .Or(
            from author in Sprache.Parse.Ref(() => Author)
            select ((RoomDeclaration?)null, (ObjectDeclaration?)null, (RuleDeclaration?)null, (PlayerDeclaration?)null,
                    (string?)null, author, (string?)null, (IReadOnlyList<VoiceDeclaration>?)null,
                    (IReadOnlyList<SoundDeclaration>?)null, (IReadOnlyList<MusicDeclaration>?)null)
        )
        .Or(
            from version in Sprache.Parse.Ref(() => Version)
            select ((RoomDeclaration?)null, (ObjectDeclaration?)null, (RuleDeclaration?)null, (PlayerDeclaration?)null,
                    (string?)null, (string?)null, version, (IReadOnlyList<VoiceDeclaration>?)null,
                    (IReadOnlyList<SoundDeclaration>?)null, (IReadOnlyList<MusicDeclaration>?)null)
        )
        .Or(
            from voices in Sprache.Parse.Ref(() => VoicesBlock)
            select ((RoomDeclaration?)null, (ObjectDeclaration?)null, (RuleDeclaration?)null, (PlayerDeclaration?)null,
                    (string?)null, (string?)null, (string?)null, voices, (IReadOnlyList<SoundDeclaration>?)null,
                    (IReadOnlyList<MusicDeclaration>?)null)
        )
        .Or(
            from sounds in Sprache.Parse.Ref(() => SoundsBlock)
            select ((RoomDeclaration?)null, (ObjectDeclaration?)null, (RuleDeclaration?)null, (PlayerDeclaration?)null,
                    (string?)null, (string?)null, (string?)null, (IReadOnlyList<VoiceDeclaration>?)null, sounds,
                    (IReadOnlyList<MusicDeclaration>?)null)
        )
        .Or(
            from music in Sprache.Parse.Ref(() => MusicBlock)
            select ((RoomDeclaration?)null, (ObjectDeclaration?)null, (RuleDeclaration?)null, (PlayerDeclaration?)null,
                    (string?)null, (string?)null, (string?)null, (IReadOnlyList<VoiceDeclaration>?)null,
                    (IReadOnlyList<SoundDeclaration>?)null, music)
        );
    ...
    private static readonly Parser<ExitDeclaration> Exit =
        ...
        from lockSegment in
            (from locked in Keyword("locked")
             ...
             select (
                        Locked: lockedValue,
                        KeyObjectId: key.IsDefined ? key.Get() : null,
                        Message: message.IsDefined ? message.Get() : null))
            .Optional()
    ...
    private static readonly Parser<(string? Start, string? Gives, int? Hp)> PlayerStatement =
        ...
        .Or(
            from gives in Keyword("gives")
            from objectId in Identifier
            select ((string?)null, objectId, (int?)null)
        )
        .Or(
            from hp in Keyword("hp")
    ...
    private static readonly Parser<(string? Name, string? Description, ObjectStatefulDescription? StatefulDescription, bool?
        Portable, bool? Container, bool? Openable, bool? Locked, bool? IsOpen, bool? Hidden, string? Contains,
        IReadOnlyList<RuleAction>? DefaultActions, IReadOnlyList<ObjectVerbDeclaration>? Verbs)> ObjectStatement =
        (from name in Keyword("name")
         from value in StringLiteral
         select (value, (string?)null, (ObjectStatefulDescription?)null, (bool?)null, (bool?)null, (bool?)null, (bool?)null,
                 (bool?)null, (bool?)null, (string?)null, (IReadOnlyList<RuleAction>?)null,
                 (IReadOnlyList<ObjectVerbDeclaration>?)null))
        .Or(
            from desc in Keyword("desc")
            from value in StringLiteral
            select ((string?)null, value, (ObjectStatefulDescription?)null, (bool?)null, (bool?)null, (bool?)null,
                    (bool?)null, (bool?)null, (bool?)null, (string?)null, (IReadOnlyList<RuleAction>?)null,
                    (IReadOnlyList<ObjectVerbDeclaration>?)null)
        )
        .Or(
            from desc in Keyword("desc")
            from value in Sprache.Parse.Ref(() => ObjectStatefulDescriptionBlock)
            select ((string?)null, (string?)null, value, (bool?)null, (bool?)null, (bool?)null, (bool?)null, (bool?)null,
                    (bool?)null, (string?)null, (IReadOnlyList<RuleAction>?)null,
                    (IReadOnlyList<ObjectVerbDeclaration>?)null)
        )
        .Or(
            from portable in Keyword("portable")
            from value in Boolean
            select ((string?)null, (string?)null, (ObjectStatefulDescription?)null, (bool?)value, (bool?)null, (bool?)null,
                    (bool?)null, (bool?)null, (bool?)null, (string?)null, (IReadOnlyList<RuleAction>?)null,
                    (IReadOnlyList<ObjectVerbDeclaration>?)null)
        )
        .Or(
            from container in Keyword("container")
            from value in Boolean
            select ((string?)null, (string?)null, (ObjectStatefulDescription?)null, (bool?)null, (bool?)value, (bool?)null,
                    (bool?)null, (bool?)null, (bool?)null, (string?)null, (IReadOnlyList<RuleAction>?)null,
                    (IReadOnlyList<ObjectVerbDeclaration>?)null)
        )
        .Or(
            from openable in Keyword("openable")
            from value in Boolean
            select ((string?)null, (string?)null, (ObjectStatefulDescription?)null, (bool?)null, (bool?)null, (bool?)value,
                    (bool?)null, (bool?)null, (bool?)null, (string?)null, (IReadOnlyList<RuleAction>?)null,
                    (IReadOnlyList<ObjectVerbDeclaration>?)null)
        )
        .Or(
            from locked in Keyword("locked")
            from value in Boolean
            select ((string?)null, (string?)null, (ObjectStatefulDescription?)null, (bool?)null, (bool?)null, (bool?)null,
                    (bool?)value, (bool?)null, (bool?)null, (string?)null, (IReadOnlyList<RuleAction>?)null,
                    (IReadOnlyList<ObjectVerbDeclaration>?)null)
        )
        .Or(
            from isOpen in Keyword("isOpen")
            from value in Boolean
            select ((string?)null, (string?)null, (ObjectStatefulDescription?)null, (bool?)null, (bool?)null, (bool?)null,
                    (bool?)null, (bool?)value, (bool?)null, (string?)null, (IReadOnlyList<RuleAction>?)null,
                    (IReadOnlyList<ObjectVerbDeclaration>?)null)
        )
        .Or(
            from hidden in Keyword("hidden")
            from value in Boolean
            select ((string?)null, (string?)null, (ObjectStatefulDescription?)null, (bool?)null, (bool?)null, (bool?)null,
                    (bool?)null, (bool?)null, (bool?)value, (string?)null, (IReadOnlyList<RuleAction>?)null,
                    (IReadOnlyList<ObjectVerbDeclaration>?)null)
        )
        .Or(
            from contains in Keyword("contains")
            ...
            select ((string?)null, (string?)null, (ObjectStatefulDescription?)null, (bool?)null, (bool?)null, (bool?)null,
                    (bool?)null, (bool?)null, (bool?)null, value, (IReadOnlyList<RuleAction>?)null,
                    (IReadOnlyList<ObjectVerbDeclaration>?)null)
        )
        .Or(
            from defaultActions in Sprache.Parse.Ref(() => ObjectDefaultBlock)
            select ((string?)null, (string?)null, (ObjectStatefulDescription?)null, (bool?)null, (bool?)null, (bool?)null,
                    (bool?)null, (bool?)null, (bool?)null, (string?)null, defaultActions,
                    (IReadOnlyList<ObjectVerbDeclaration>?)null)
        )
        .Or(
            from verbs in Sprache.Parse.Ref(() => ObjectVerbsBlock)
            select ((string?)null, (string?)null, (ObjectStatefulDescription?)null, (bool?)null, (bool?)null, (bool?)null,
                    (bool?)null, (bool?)null, (bool?)null, (string?)null, (IReadOnlyList<RuleAction>?)null, verbs)
        );
    ...
    private static readonly Parser<RuleCondition> RuleCondition =
        ...
        .Or(
            from has in Keyword("has")
            from objectId in Identifier
            select (RuleCondition)new HasCondition(objectId)
        )
        .Or(
            from exitLocked in Keyword("exitLocked")
            from roomId in Identifier
            from direction in DirectionParser
    ...
    private static readonly Parser<RuleAction> RuleAction =
        ...
        .Or(
            from open in Keyword("open")
            from objectId in Identifier
            select (RuleAction)new OpenAction(objectId)
        )
        .Or(
            from unlock in Keyword("unlock")
            from exit in Keyword("exit")
            from roomId in Identifier
            from direction in DirectionParser
    ...
    public static GameDocument Parse(string source)
    {
        ...
        var sanitizedSource = StripComments(source);
    ...
    private static GameDocument BuildDocument(
        string title,
        string startRoom,
        IEnumerable<(RoomDeclaration? Room, ObjectDeclaration? Object, RuleDeclaration? Rule, PlayerDeclaration? Player,
            string? Include, string? Author, string? Version, IReadOnlyList<VoiceDeclaration>? Voices,
            IReadOnlyList<SoundDeclaration>? Sounds, IReadOnlyList<MusicDeclaration>? Music)> declarations
    )
    {
        ...
        foreach ((RoomDeclaration? room, ObjectDeclaration? obj, RuleDeclaration? rule, PlayerDeclaration? playerDecl, string
                 ? include, string? authorDeclaration, string? versionDeclaration, IReadOnlyList<VoiceDeclaration>?
                 voicesBlock, IReadOnlyList<SoundDeclaration>? soundsBlock, IReadOnlyList<MusicDeclaration>? musicBlock)
                 declaration in declarations)
        {
            ...
            {
                foreach (var blockVoice in declaration.voicesBlock)
                {
            ...
            {
                foreach (var blockSound in declaration.soundsBlock)
                {
            ...
            {
                foreach (var blockMusic in declaration.musicBlock)
                {
    ...
    private static ObjectDeclaration BuildObject(
        string id,
        IEnumerable<(string? Name, string? Description, ObjectStatefulDescription? StatefulDescription, bool? Portable, bool?
            Container, bool? Openable, bool? Locked, bool? IsOpen, bool? Hidden, string? Contains, IReadOnlyList<RuleAction>?
            DefaultActions, IReadOnlyList<ObjectVerbDeclaration>? Verbs)> statements
    )
    {
        string? name = null;
        ...
        foreach (var (stmtName, stmtDesc, stmtStatefulDescription, stmtPortable, stmtContainer, stmtOpenable, stmtLocked,
                     stmtIsOpen, stmtHidden, stmtContains, stmtDefaultActions, stmtVerbs) in statements)
        {
    ...
    private static ObjectVerbDeclaration BuildObjectVerb(
        string verb,
        string? variable,
        IEnumerable<(int Kind, RuleCondition? Condition, RuleAction? Action)> statements
    )
    {
        ...
        foreach (var (kind, condition, action) in statements)
        {
        ...
        return new(verb, variable, conditions, actions, elseActions);
    }
    ...
    private static PlayerDeclaration BuildPlayer(IEnumerable<(string? Start, string? Gives, int? Hp)> statements)
    {
        ...
        foreach (var (stmtStart, stmtGives, stmtHp) in statements)
        {
        ...
        return new(startRoomId, givesObjectId, hp);
    }

    private static RoomDeclaration BuildRoom(
        string id,
        IEnumerable<(string? Name, string? Image, string? Description, string? Ambient, ExitDeclaration? Exit, string?
            Contains)> statements
    )
    {
        string? name = null;
        ...
        foreach (var (stmtName, stmtImage, stmtDesc, stmtAmbient, stmtExit, stmtContains) in statements)
        {
            if (stmtName is not null)
            {
                name = stmtName;
        ...
        return new(id, name, image, description, ambient, exits, contains);
    }
    ...
    private static Parser<string> Keyword(string keyword)
        => Sprache.Parse.String(keyword).Text().Token();

    private static string StripComments(string source)
    {
        var input = source.AsSpan();
        var output = source.Length <= 4096 ? stackalloc char[source.Length] : new char[source.Length];
