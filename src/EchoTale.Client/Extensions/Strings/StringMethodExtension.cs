...
namespace EchoTale.Client.Extensions.Strings;
...
{
    /// <summary>
    /// Extension methods for string case conversions, allowing for easy transformation of strings into various cases such as camelCase, PascalCase, snake_case, etc.
    /// </summary>
